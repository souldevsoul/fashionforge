    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="bg-purple-400 border-4 border-black brutalist-shadow p-8 text-center">
            <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center mx-auto mb-4">
              <RiCheckLine className="w-10 h-10 text-purple-400" />
            </div>
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        {/* Selected Plan Badge */}
        {selectedPlan === 'pro' && (
          <div className="bg-purple-400 border-4 border-black brutalist-shadow p-4 mb-6 text-center">
        ...
        <div className="bg-white border-4 border-black brutalist-shadow p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Welcome Bonus Info */}
            <div className="bg-purple-50 border-4 border-purple-400 p-4">
        ...
        <div className="min-h-screen bg-white flex items-center justify-center">
          <div className="text-center">
            <div className="w-16 h-16 bg-black flex items-center justify-center mx-auto mb-4 animate-pulse">
              <RiUserLine className="w-10 h-10 text-purple-400" />
            </div>
