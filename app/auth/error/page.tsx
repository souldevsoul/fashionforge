        ...
        <div className="bg-white border-4 border-red-500 brutalist-shadow p-8">
          <div className="text-center">
            ...
            <div className="space-y-4">
              <Button
                className="w-full h-12 gap-3 bg-black text-purple-400 hover:bg-gray-900 border-4 border-black font-bold uppercase"
        ...
        <div className="min-h-screen bg-white flex items-center justify-center">
          <div className="text-center">
            <div className="w-16 h-16 bg-black flex items-center justify-center mx-auto mb-4">
              <RiErrorWarningLine className="w-10 h-10 text-purple-400 animate-pulse" />
            </div>
