    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "Your use of the Service is subject to the limits of your subscription plan (character limits, API rate limits, design variations). Exceeding these limits may result in additional charges or temporary service restrictions. Enterprise customers can negotiate custom limits.",
        },
        {
          subtitle: "API Usage",
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "Creating fashion designs for illegal purposes, fraud, scams, or deception; impersonating others without consent; generating content that violates any laws or regulations.",
        },
        {
          subtitle: "Harmful Content",
          text: "Creating content that harasses, threatens, or harms others; generating hate apparel, discriminatory, or violent content; creating deepfakes or misleading design without disclosure; producing content that infringes on others' rights.",
        },
        {
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          text: "You retain ownership of the text inputs you provide and the design files you upload for design generation. By using the Service, you grant us a limited license to process your content solely to provide the Service. We do not claim ownership of your content.",
        },
        {
          subtitle: "Generated Content",
          text: "You own the design files generated by the Service using your inputs. However, you are responsible for ensuring your use of generated content complies with applicable laws and these Terms. You must not claim that generated content is a real human voice without disclosure.",
        },
        {
      ...
      content: [
        {
          ...
          text: "You are solely responsible for the content you create using our Service, including text inputs, design variations, and generated design. You represent and warrant that you have all necessary rights, licenses, and permissions to use such content.",
        },
        {
        ...
        },
        {
          ...
          text: "If you publish or distribute AI-generated design, you agree to clearly disclose that it was created using AI technology. This disclosure must be prominent and not misleading. Failure to disclose may result in account termination.",
        },
      ],
    },
    {
  ...
  const disclaimerSections = [
    {
      ...
      content: [
        ...
        {
          text: "We do not warrant that the Service will be uninterrupted, error-free, or secure. We do not warrant the accuracy, reliability, or quality of generated design. We are not responsible for any damage caused by your use of the Service.",
        },
        {
