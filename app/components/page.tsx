    ...
    <div className="min-h-screen bg-white">
      ...
      <Container maxWidth="xl" className="py-16 space-y-28">
        ...
        <section>
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-purple-400 flex items-center justify-center border-4 border-black">
                <FiBox className="w-6 h-6 text-black" />
              </div>
              <Heading variant="h2" className="text-black uppercase">Core Components</Heading>
            </div>
            <div className="h-1 w-24 bg-purple-400" />
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="space-y-10">
              ...
              <div className="p-10 bg-black border-4 border-black brutalist-shadow">
                <Text variant="body-sm" className="text-purple-400 mb-6 font-bold uppercase tracking-wider flex items-center gap-2">
                  <div className="w-4 h-4 bg-purple-400" />
                  Primary Actions
                </Text>
                <div className="flex flex-wrap gap-6">
                  <Button variant="primary" className="gap-2 bg-purple-400 text-black hover:bg-purple-300 border-4 border-black font-bold uppercase">
              ...
              <div className="p-10 bg-white border-4 border-black brutalist-shadow-purple">
                ...
                <div className="flex flex-wrap gap-6">
                  ...
                  <Button variant="outline" className="gap-2 bg-white text-black border-4 border-black hover:bg-purple-400 font-bold uppercase">
                    <RiExternalLinkLine className="w-5 h-5" />
                    View
                  </Button>
                  <Button variant="ghost" className="gap-2 text-black hover:bg-purple-400 border-4 border-transparent hover:border-black font-bold uppercase">
              ...
              {/* Size Variations */}
              <div className="p-10 bg-purple-400 border-4 border-black">
                <Text variant="body-sm" className="text-black mb-6 font-bold uppercase tracking-wider flex items-center gap-2">
                  <div className="w-4 h-4 bg-black" />
                  Button Sizes
                </Text>
                <div className="flex flex-wrap items-center gap-6">
                  <Button size="sm" className="gap-2 bg-black text-purple-400 border-4 border-black font-bold uppercase">
                    <RiStarLine className="w-3.5 h-3.5" />
                    Small
                  </Button>
                  <Button size="md" className="gap-2 bg-black text-purple-400 border-4 border-black font-bold uppercase">
                    <RiStarLine className="w-4 h-4" />
                    Medium
                  </Button>
                  <Button size="lg" className="gap-2 bg-black text-purple-400 border-4 border-black font-bold uppercase">
                    <RiStarLine className="w-5 h-5" />
                    Large
                  </Button>
                  <Button size="xl" className="gap-2 bg-black text-purple-400 border-4 border-black font-bold uppercase">
                    <RiStarLine className="w-5 h-5" />
                    XL
                  </Button>
                </div>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card variant="default" padding="lg" className="group bg-white border-4 border-black hover:brutalist-shadow-purple transition-all duration-200">
                ...
                <Button variant="ghost" size="sm" className="gap-2 text-black hover:text-purple-400 font-bold uppercase border-2 border-black">
                  Explore
              ...
              <Card variant="elevated" padding="lg" className="group bg-black border-4 border-black brutalist-shadow">
                <div className="w-16 h-16 bg-purple-400 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border-4 border-black">
                  <TbWaveSine className="w-8 h-8 text-black" />
                </div>
                <Heading variant="h4" className="mb-3 text-purple-400 uppercase">Black Card</Heading>
                <Text variant="body-sm" className="text-gray-300 mb-6 font-semibold">
                  Bold black background with dramatic yellow accents
                </Text>
                <Button variant="secondary" size="sm" className="gap-2 bg-purple-400 text-black border-4 border-purple-400 font-bold uppercase">
                  Discover
              ...
              {/* Yellow Card */}
              <Card variant="gradient" padding="lg" className="group bg-purple-400 border-4 border-black hover:brutalist-shadow transition-all">
                ...
                <Button variant="primary" size="sm" className="gap-2 bg-black text-purple-400 border-4 border-black font-bold uppercase">
                  View More
                  <RiArrowRightLine className="w-4 h-4" />
                </Button>
              </Card>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl">
              ...
              <div className="p-8 bg-black border-4 border-black">
                <label className="block text-sm font-bold text-purple-400 mb-4 uppercase tracking-wide">
                  Large Input
                </label>
                <Input inputSize="lg" placeholder="LARGER TEXT..." className="border-4 border-purple-400 bg-white font-semibold uppercase" />
              </div>
            </div>
          </div>
          ...
          <div className="p-12 bg-white border-4 border-black brutalist-shadow-purple">
            ...
            <div className="space-y-8">
              ...
              <div className="p-6 bg-purple-400 border-4 border-black">
        ...
        <section>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card variant="elevated" padding="lg" className="bg-purple-400 border-4 border-black brutalist-shadow">
                <Text variant="body-sm" className="text-black mb-4 font-bold uppercase tracking-wider flex items-center gap-2">
                  <TbWaveSine className="w-5 h-5" />
                  Medium
                </Text>
              ...
              <Card variant="elevated" padding="lg" className="bg-black border-4 border-black">
                <Text variant="body-sm" className="text-purple-400 mb-4 font-bold uppercase tracking-wider flex items-center gap-2">
                  <TbWaveSine className="w-5 h-5" />
                  Large
                </Text>
        ...
        <section>
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <TestimonialCard
                quote="FashionForge has completely transformed our audiobook production pipeline. We've cut production time by 80% while maintaining incredible quality."
        ...
        <section>
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-purple-400 flex items-center justify-center border-4 border-black brutalist-shadow">
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-8 bg-black border-4 border-black brutalist-shadow-purple">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="w-20 h-20 bg-black border-4 border-purple-400" />
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-20 h-20 bg-white border-4 border-purple-400" />
                    <div>
              ...
              <div className="p-8 bg-purple-400 border-4 border-black brutalist-shadow">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <div className="w-20 h-20 bg-purple-500 border-4 border-black" />
                    <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-20 h-20 bg-purple-400 border-4 border-black" />
                    <div>
      ...
      <div className="bg-black py-24 mt-28 border-t-8 border-purple-400">
        <Container maxWidth="lg">
          <div className="text-center">
            ...
            <Heading variant="h1" className="mb-6 text-purple-400 uppercase">START BUILDING NOW</Heading>
            ...
            <div className="flex flex-wrap gap-6 justify-center">
              ...
              <Button
                variant="outline"
                size="xl"
                className="gap-3 text-purple-400 border-4 border-purple-400 hover:bg-purple-400 hover:text-black font-bold uppercase"
              >
