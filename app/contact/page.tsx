            ...
            {contactMethods.map((method, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 ${
                      method.color === "white" ? "bg-black" : method.color === "black" ? "bg-purple-400" : "bg-black"
                  ...
                  <h3
                    className={`text-2xl font-bold uppercase mb-4 ${
                      method.color === "black" ? "text-purple-400" : "text-black"
                    }`}
                  >
                    {method.title}
                  </h3>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    name="name"
                    required
                    className="w-full px-4 py-3 border-4 border-black focus:outline-none focus:ring-4 focus:ring-purple-400 font-medium"
                ...
                <div>
                  ...
                  <select
                    ...
                    name="subject"
                    required
                    className="w-full px-4 py-3 border-4 border-black focus:outline-none focus:ring-4 focus:ring-purple-400 font-medium bg-white"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 border-4 border-black focus:outline-none focus:ring-4 focus:ring-purple-400 font-medium resize-none"
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full bg-purple-400 text-black border-4 border-black font-bold uppercase hover:bg-purple-300"
                >
              ...
              >
                <h3
                  className={`text-2xl font-bold uppercase mb-6 ${
                    index % 2 === 0 ? "text-black" : "text-purple-400"
                  }`}
                >
                  {topic.title}
                </h3>
      ...
      <section className="py-24 bg-black border-t-8 border-purple-400">
        <Container maxWidth="xl">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold uppercase mb-6 text-purple-400">
            ...
            <div className="p-8 bg-white border-4 border-white brutalist-shadow-yellow">
              ...
              <Button
                size="lg"
                className="bg-black text-purple-400 border-4 border-black font-bold uppercase"
                asChild
              >
                <a href="mailto:enterprise@fashionforge.ai">
