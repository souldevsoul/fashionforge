          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              <CardTitle className="flex items-center gap-2 text-rose-900">
                <RiFileAddLine className="h-6 w-6 text-pink-600" />
        ...
        <AlertDialogContent className="border-4 border-black sm:max-w-[600px]">
                ...
                {allAudios
                  ...
                  .map((audio, index) => (
                    <div key={audio.id} className="flex items-center gap-2">
                      <RiCheckLine className="h-4 w-4 text-purple-600" />
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={loading}
              className="bg-rose-400 text-black border-4 border-black hover:bg-pink-500"
            >
