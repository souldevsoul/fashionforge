    ...
    return (
      <div ref={ref} className={cn("space-y-6", className)} {...props}>
        ...
        >
          <Stack align="center" gap="md" p="xl">
            <div className="relative">
              ...
              <div className="relative inline-flex items-center justify-center w-20 h-20 bg-purple-400 border-4 border-black shadow-lg">
            ...
            <div className="text-center">
              ...
              <Group justify="center" gap={4}>
                <Badge variant="filled" color="yellow" size="sm" className="bg-purple-400 text-black border-2 border-black font-bold uppercase">
        ...
        <Card
          variant="ghost"
          padding="md"
          className="border-2 border-rose-200 bg-pink-50"
        >
          <Stack gap="xs">
        ...
        {uploadedFiles.length > 0 && (
          <Stack gap="sm">
            <Group justify="space-between" align="center">
              ...
              <Badge variant="filled" size="lg" radius="sm" className="bg-purple-400 text-black border-2 border-black font-bold uppercase">
