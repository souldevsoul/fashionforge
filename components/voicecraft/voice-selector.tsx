          ...
          <div className="flex flex-wrap gap-4 items-center justify-between">
            ...
            <div className="flex gap-2 items-center">
              ...
              <select
                ...
                className="px-3 py-2 border-2 border-black text-sm font-bold uppercase focus:outline-none focus:ring-2 focus:ring-purple-400"
              >
          ...
          {filteredVoices.map((voice) => (
            <Card
              ...
              className={cn(
                ...
                selectedVoiceId === voice.id && "ring-2 ring-purple-400 ring-offset-2"
              )}
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex flex-col gap-2 flex-shrink-0">
                  ...
                  <Button
                    ...
                    className={cn(
                      "w-8 h-8",
                      voice.isFavorite && "text-purple-500"
                    )}
                    onClick={(e) => {
                      e.stopPropagation()
