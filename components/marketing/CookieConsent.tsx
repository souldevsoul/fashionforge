            ...
            {showSettings ? (
              ...
              <div className="p-8">
                ...
                <div className="space-y-4 mb-6">
                  {/* Necessary Cookies */}
                  <div className="flex items-start gap-4 p-4 border-4 border-black bg-purple-50">
                    <input
                      type="checkbox"
                      checked={true}
                      disabled
                ...
                <div className="flex flex-wrap gap-4">
                  <Button
                    ...
                    className="gap-2 bg-black text-purple-400 hover:bg-gray-900 border-4 border-black font-bold uppercase brutalist-shadow"
                  >
              ...
              <div className="p-6 md:p-8">
                <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 bg-purple-400 border-4 border-black flex items-center justify-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                    <Button
                      ...
                      size="lg"
                      className="gap-2 bg-black text-purple-400 hover:bg-gray-900 border-4 border-black font-bold uppercase brutalist-shadow whitespace-nowrap"
                    >
                      <RiCheckLine className="w-5 h-5" />
                      Accept All
                    </Button>
