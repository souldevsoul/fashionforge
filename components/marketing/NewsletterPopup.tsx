    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          ...
          <div className="relative bg-purple-400 border-b-8 border-black p-6">
            <button
              onClick={handleClose}
              className="absolute top-4 right-4 w-10 h-10 bg-black text-purple-400 flex items-center justify-center hover:bg-gray-900 transition-colors"
              aria-label="Close"
            >
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-black mb-3">
                  <RiSparklingLine className="w-5 h-5 text-purple-400" />
          ...
          {/* Bottom Accent */}
          <div className="h-4 bg-purple-400 border-t-4 border-black" />
        </div>
      </div>
    </>
  )
