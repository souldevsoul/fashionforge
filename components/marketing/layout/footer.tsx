...
export function Footer() {
  ...
  return (
    <footer className="bg-black text-white border-t-8 border-purple-400">
      {/* Main Footer Content */}
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-2xl font-bold uppercase mb-6 text-purple-400">
              FashionForge
            </h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold uppercase mb-6 text-purple-400">
              Product
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/refund-policy" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Refund Policy
                </Link>
              </li>
              <li>
                <Link href="/cancellation-policy" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Cancellation Policy
                </Link>
              </li>
              <li>
                <Link href="/payment-policy" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Payment Policy
                </Link>
              </li>
              <li>
                <Link href="/delivery-policy" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Delivery Policy
                </Link>
              </li>
              <li>
                <Link href="/cookie-policy" className="text-gray-300 hover:text-purple-400 transition-colors">
                  Cookie Policy
                </Link>
              </li>
            </ul>
      ...
      <div className="border-t-4 border-purple-400">
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              <h5 className="text-sm font-bold uppercase text-purple-400 mb-3">
                Company Information
              </h5>
              <div className="text-sm text-gray-300 space-y-1">
                <p>
                  <span className="font-bold">Legal Name:</span> FashionForge, Inc.
                </p>
                <p>
          ...
          <div className="pt-6 border-t-2 border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
              <p>
                © {currentYear} FashionForge, Inc. All rights reserved.
              </p>
