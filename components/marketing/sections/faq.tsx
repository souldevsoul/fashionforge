                  ...
                  {colItems.map((item, itemIndex) => (
                    ...
                    >
                      <AccordionPrimitive.Header>
                        <AccordionPrimitive.Trigger className="flex w-full items-center justify-between py-5 text-left text-lg font-bold text-slate-900 hover:text-purple-500 transition-colors group uppercase">
                          {item.question}
