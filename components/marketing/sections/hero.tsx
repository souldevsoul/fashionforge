    ...
    return (
      ...
      >
            ...
            <div className="text-center lg:text-left">
              ...
              {badge && (
                <div className="mb-6 animate-fade-in">
                  <span className="inline-block px-4 py-2 text-sm font-bold text-black bg-purple-400 border-2 border-black uppercase">
                    {badge}
                  </span>
                </div>
              )}
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-20">
          <div className="absolute top-20 left-10 w-72 h-72 bg-purple-400 rounded-full filter blur-3xl" />
