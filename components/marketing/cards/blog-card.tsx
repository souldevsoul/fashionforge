    ...
    return (
      ...
      >
        ...
        <CardContent className="p-6">
          ...
          {category && (
            <div className="mb-3">
              <span className="inline-block px-3 py-1 text-xs font-bold text-black bg-purple-400 border-2 border-black uppercase">
                {category}
              </span>
            </div>
          )}
          ...
          <CardHeader className="p-0 mb-3">
            <CardTitle className="text-xl line-clamp-2 group-hover:text-purple-500 transition-colors">
              {title}
            </CardTitle>
          </CardHeader>
