# Developer Setup Guide - FashionForge

Welcome to FashionForge! This guide will help you get started as a new developer on this project.
...
> "Hi! I'm starting on FashionForge. I need:
...
**If you see errors:**
- Make sure you're in the `fashionforge` folder: `pwd` (should show the path to fashionforge)
...
1. **Make sure you're in the project folder:**
   ```bash
   cd ~/Documents/fashionforge  # Or wherever you cloned it
   ```
...
2. **Start Claude Code:**
   ...
   Working directory: /path/to/fashionforge
   Type 'exit' to quit.
   ```
...
FashionForge uses a **warm, playful, pet-friendly** design system:
...
FashionForge implements a Human-in-the-Loop approach where certain portraits can be assigned to human executors for manual review or enhancement.
