...
You are helping a developer align a page or component to LogoSmith's design system. This is for cases where the functionality works, but the visual style doesn't match the brand.
...
Fix visual/style inconsistencies to match LogoSmith's design system.
...
## Step 2: LogoSmith Design System Reference
